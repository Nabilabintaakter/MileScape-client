    ...
    return (
        <div className='w-[95%] md:w-[90%] mx-auto max-w-7xl mb-5 md:mb-10'>
            <Fade direction="up" triggerOnce duration={2000}>
                <div className="mt-12 text-center bg-gradient-to-r from-blue-100 to-blue-200 py-12 px-6 rounded-lg shadow-lg">
                    <h2 className="text-4xl font-bold text-blue-700 mb-6">Why Choose Milescape?</h2>
                    <p className="text-lg text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
                        ...
                        <br />
                        <span className="font-semibold">Here’s why you should choose Milescape:</span>
                    </p>
