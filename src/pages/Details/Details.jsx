                        ...
                        <div className="md:w-1/2 p-4 bg-yellow-50">
                            ...
                            <Fade triggerOnce delay={800} direction="down">
                                <Link to={`/registration/${_id}`}
                                    className={`bg-blue-600 text-white hover:bg-gray-100 hover:text-blue-800 hover:border-2 hover:border-blue-800 border-2 border-blue-600 btn rounded-lg text-lg w-full md:w-auto transition duration-500 ${isRegistrationOpen ? '' : 'opacity-50 cursor-not-allowed'}`}
