...
const Marathons = () => {
    ...
    return (
        <div className='bg-gray-50 dark:bg-[#1A1A1A]'>
            <div className='w-[90%] mx-auto max-w-7xl pb-5 md:pb-10'>
                <Fade direction="up" triggerOnce duration={2000}>
                    <div className='pt-3 mb-5 md:pt-5 md:mb-10 lg:mb-14'>
                ...
                <div className="flex flex-row flex-wrap justify-end items-center gap-5 -mt-4 lg:-mt-12 mb-3">
                    <div>
                        <select
                            name="sort"
                            id="sort"
                            className="btn btn-sm md:btn-md border border-gray-700 rounded-md bg-white hover:bg-gray-700 hover:text-white mt-5 md:mt-0"
